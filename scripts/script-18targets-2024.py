...
directorios_a_usar_1=[i for i in directorios if "2018" in i or "2019" in i or "2020" in i or "2021" in i or "2022" in i or "2023" in i or "2024" in i] 
directorios_a_usar_2=[i for i in directorios if "2022" in i or "2023" in i or "2024" in i] 

# targets
list_of_targets_1 = ['HD205286', 'HD31501','TOI1199', 'TOI1836', 'TOI5076']
list_of_targets_2 = ['HD185144', 'HD89269', 'HD9407', 'HD205286', 'HD31501', 'HD224016', 'HD17820', 'BD+700503', 'TOI1273', 'TOI1736', 'TOI2134', 
'TOI1710', 'TOI1296', 'TOI1298', 'HD88986', 'TOI1199', 'TOI1836', 'TOI5076']


# correr para toda la lista de estrellas
for star in list_of_targets_1:
    salida = open("/home/jserrano/scripts/new_data_2024/2018-2024/planets_dataset_ccf_"+star+".dat","w") # Archivo1 de salida
    salida2 = open("/home/jserrano/scripts/new_data_2024/2018-2024/planets_dataset_e2ds_"+star+".dat","w") # Archivo2 de salida
    for i in directorios_a_usar_1:
...
for star in list_of_targets_2:
    salida = open("/home/jserrano/scripts/new_data_2024/2022-2024/planets_dataset_ccf_"+star+".dat","w") # Archivo1 de salida
    salida2 = open("/home/jserrano/scripts/new_data_2024/2022-2024/planets_dataset_e2ds_"+star+".dat","w") # Archivo2 de salida
    for i in directorios_a_usar_2:
        os.chdir(i)                        # Cambia el directorio de trabajo
        result = buscar_archivos(i,star)        # Corre la funcion (script)
        result2 = buscar_archivos2(i,star)
        p = result.stdout.splitlines()     # Separa linea por linea
